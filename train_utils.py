...
if(save_png):   
    ...
    try:
        ...
        print("> WARNING Directory: /" + param_dir_lr_png + "/subsamples_hr_rev_shuff" + " already exists.\n>> Overwriting data...")
    ...
    for i in range(len(subsamples_hr_rev_shuff)):
        np.save(param_dir_lr_png + "/subsamples_hr_rev_shuff" + '/' + 'hr_ss_' + subsample_filenames[i], subsamples_hr_rev_shuff[i])
